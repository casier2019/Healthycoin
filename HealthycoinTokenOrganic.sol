...
// ----------------------------------------------------------------------------
// Healthycoin Token 👊 + v1.20-pre-release
//
// Fully healthy and Organic for a factory to conveniently deploy your own source code verified fixed supply
// token contracts
//
// Factory deployment address: 0x{something}
//
// https://github.com/casier2019/Healthycoin
//
// Enjoy. (c) Cryptless / Abil Healthy Group Consulting Pty Ltd 2019. The MIT Licence.
// ----------------------------------------------------------------------------
...
// ----------------------------------------------------------------------------
// HTC Token Standard #20 Interface
...
// ----------------------------------------------------------------------------
// Token Interface = HTC + symbol + name + decimals + approveAndCall
// ----------------------------------------------------------------------------
contract TokenInterface is HTCInterface {
...
// ----------------------------------------------------------------------------
// HealthycoinToken 👊 = HTC + symbol + name + decimals + approveAndCall
// ----------------------------------------------------------------------------
contract HealthycoinToken is TokenInterface, Owned {
...
// ----------------------------------------------------------------------------
// Cryptless Healthycoin Fixed Supply Token 👊 Healthy and Organic
//
// Notes:
...
// your very own HealthycoinToken contract:
//   symbol         symbol
//   name           name
//   decimals       number of decimal places for the token contract
//   totalSupply    the fixed token total supply
//
// For example, deploying a HealthycoinToken contract with a `totalSupply`
...
//   totalSupply    the fixed token total supply
// ----------------------------------------------------------------------------
contract HealthycoinTokenOrganic is Owned {
    using SafeMath for uint;
